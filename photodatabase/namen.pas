...
type
  TForm2 = class(TForm)
    ...
    procedure holebasispfadn(pfad:string);
  private
...
begin
form2.visible:=false;
form1.listbox3.Items.LoadFromFile(p1+'/namenliste.dat');    //Schließen und Aktualisieren
end;

procedure TForm2.Button5Click(Sender: TObject);
begin
listbox1.Items.SaveToFile(p1+'/namenliste.dat');   //Speichern
end;
...
a:=-1;
  ...
  procedure Tform2.holebasispfadn(pfad:string);
  begin
