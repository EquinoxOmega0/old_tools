MODULE nrutil
	...
	INTERFACE array_copy
		MODULE PROCEDURE array_copy_r, array_copy_i   ! changed
	END INTERFACE
	INTERFACE swap
	...
	END INTERFACE
	INTERFACE arth
		MODULE PROCEDURE arth_r, arth_i   ! changed
	END INTERFACE
	INTERFACE geop
		MODULE PROCEDURE geop_r, geop_i, geop_c, geop_dv   ! changed
	END INTERFACE
	INTERFACE cumsum
		MODULE PROCEDURE cumsum_r,cumsum_i
	END INTERFACE
	INTERFACE poly
		MODULE PROCEDURE poly_rr,poly_rrv, &                ! changed
	...
	END INTERFACE
	INTERFACE outerprod
		MODULE PROCEDURE outerprod_r    ! changed
	END INTERFACE
	INTERFACE outerdiff
		MODULE PROCEDURE outerdiff_r,outerdiff_i    ! changed
	END INTERFACE
	INTERFACE scatter_add
		MODULE PROCEDURE scatter_add_r          ! changed
	END INTERFACE
	INTERFACE scatter_max
		MODULE PROCEDURE scatter_max_r   ! changed
	END INTERFACE
	INTERFACE diagadd
	...
	END INTERFACE
	INTERFACE get_diag
		MODULE PROCEDURE get_diag_rv         ! changed
	END INTERFACE
	INTERFACE put_diag
